						...
						<div className="row kill-margin">
							...
							<div className='col-xs-12 center-text padding-none contain-table'> 
								<table className='margin-above middle-of-div'>
									...
									<tbody>
										<tr className='taller-table-rows'>					
											<td className='data-entry'><a href='https://www.goodreads.com/book/show/12936.Gathering_Blue' target="_blank">Gathering Blue</a></td>
											<td className='data-entry'>Lois Lowry</td>										
											<td className='data-entry'>Currently Reading</td>										
										</tr>

										<tr className='taller-table-rows'>					
											<td className='data-entry'><a href='https://www.goodreads.com/book/show/88815.The_Reluctant_Fundamentalist' target="_blank">Moth Smoke</a></td>
