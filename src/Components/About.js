      ...
      <div className="padding-none">
        <div className="col-xs-12">
          <div className="col-xs-12 col-sm-3 col-md-2 personal-photo-div col-lg-3">
            <img
              ...
              src="../../Images/professional-picture-of-me.jpeg"
            />
          </div>
          ...
          <div className="col-xs-12 col-sm-9 col-md-10 col-lg-6 description-text-smaller margin-above padding-right-zero">
            Prior to software development, I worked as an investment banking
            analyst (Technology & Services Group) for{" "}
            <a
              target="_blank"
              href="http://www.rwbaird.com/investment-banking/"
            >
              Baird.
            </a>
          </div>
        ...
        <div className="col-xs-12 col-lg-6 margin-above center-text">
          ...
          <div>
            {" "}
            <img
              className="about-me-company-photo margin-above"
              src="../../Images/digitalcrafts-logo-1200-new.png"
              height="80"
              width="200"
            />{" "}
          </div>
          ...
          <div>
            <p>
              {" "}
              DigitalCrafts is a sixteen week, immersive, full-time accelerated
              learning program. The goal of the program is to prepare its
              students to be full-stack developers and software engineers upon
              graduation. There is a strong emphasis on efficient code design,
              version control, responsive applications, and analytical thinking.
              Learn more{" "}
          ...
          <div>
            ...
            <img
              className="about-me-company-photo margin-above"
              src="../../Images/university-of-wisco-logo.png"
            />{" "}
          </div>
          {/* Text university of wisconsin description */}
          <p>
            {" "}
            I graduated from the University of Wisconsin-Madison with a B.B.A in
            Finance. Outside of the classroom, I spent time working as a
            teaching assistant, working at a local bar, and playing tennis on
            the club team.{" "}
          </p>
        </div>
        ...
        <div className="col-xs-12 col-lg-6 margin-above center-text">
          ...
          <div className="work-block">
            ...
            <div>
              ...
              >
                <li style={{ fontSize: 14, color: "black" }}>HTML</li>
                <li style={{ fontSize: 14, color: "black" }}>CSS</li>
                <li style={{ fontSize: 14, color: "black" }}>JavaScript</li>
                <li style={{ fontSize: 14, color: "black" }}>React</li>
                <li style={{ fontSize: 14, color: "black" }}>D3</li>
				<li style={{ fontSize: 14, color: "black" }}>Storybook</li>
                <li style={{ fontSize: 14, color: "black" }}>Amazon S3</li>
                <li style={{ fontSize: 14, color: "black" }}>Amazon Route53</li>
                <li style={{ fontSize: 14, color: "black" }}>Webpack</li>
                <li style={{ fontSize: 14, color: "black" }}>Node.js</li>
				<li style={{ fontSize: 14, color: "black" }}>CircleCI</li>
                <li style={{ fontSize: 14, color: "black" }}>Git</li>
                <li style={{ fontSize: 14, color: "black" }}>Github</li>
                <li style={{ fontSize: 14, color: "black" }}>JIRA</li>
              </p>
            </div>
		  ...
		  <div className="work-block">
            ...
            <div>
              ...
              >
                ...
                <li style={{ fontSize: 14, color: "black" }}>JavaScript</li>
                <li style={{ fontSize: 14, color: "black" }}>React</li>
				<li style={{ fontSize: 14, color: "black" }}>Redux</li>
              </p>
            </div>
